...
public abstract class AMQPSamplerGui extends AbstractSamplerGui {
    ...
    private final JLabeledTextField altExchange = new JLabeledTextField("Alternate Exchange");
    private final JLabeledTextField deadLetterExchange = new JLabeledTextField("Dead Letter Exchange");
    ...
    public void configure(TestElement element) {
        ...
        altExchange.setText(sampler.getAlternateExchange());
        deadLetterExchange.setText(sampler.getDeadLetterExchange());
    ...
    public void clearGui() {
        ...
        altExchange.setText(AMQPSampler.DEFAULT_ALTERNATE_EXCHANGE);
    ...
    public void modifyTestElement(TestElement element) {
        ...
        sampler.setAlternateExchange(altExchange.getText());
        sampler.setDeadLetterExchange(deadLetterExchange.getText());
    ...
    private Component makeCommonPanel() {
        ...
        exchangeSettings.add(altExchange, gridBagConstraints);

        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        exchangeSettings.add(deadLetterExchange, gridBagConstraints);
